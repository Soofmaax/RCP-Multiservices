...
export default function GoogleReviewsBadge({
  ...
  return (
    <a
      ...
      rel="noreferrer"
      aria-label={label}
      className={`inline-flex items-center gap-2 rounded border border-gray-300 px-3 py-1.5 text-sm bg-white hover:bg-gray-50 shadow-sm ${className}`}
    >
      <GoogleIcon />
      <span className="font-medium text-gray-800">Avis Google</span>
    </a>
  );
}
